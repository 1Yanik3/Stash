...
import prisma from "../../_frontend/src/lib/server/prisma"
import sharedImportLogic from "../../_frontend/src/lib/server/sharedImportLogic"
...
export default async (job: Job) => {
  ...
  const downloadProcess = exec(
    `yt-dlp --newline -o ./media/${mediaId} ${data.url}`
  )
